      ...
      <section class="content">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-line-chart"></i> Profit & Loss  Form</h3>
          </div>
          <div class="box-body">
            <div class="page-content-inner">
              <form method="get" target="_blank" action="<?php echo site_url("profit_loss/profit_loss/view_pl") ?>" target="_blank">
                <div class="row">
                  <div class="col-md-3">
