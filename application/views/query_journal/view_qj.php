                    ...
                    <div class="page-content-inner">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th width="90px" style="text-align: center">GL NUMBER</th>
                                <th width="100px" style="text-align: center">REFRENCES NO.</th>
                            ...
                            <tr>
                                ...
                                <td align="center"><span
                                        class="<?php echo $label ?>"><?php echo strtoupper($gg->Fmodule) ?></span></td>
                                <td align="center"><?php echo $gg->gl_no ?></td>
                                <td align="center"><?php echo $gg->reff_no ?></td>
                                <td align="center"><?php echo $gg->gl_date ?></td>
                                <td><?php echo $gg->description ?></td>
                                <td align="right"><?php echo number_format($gg->total) ?></td>

                                <td>

                                    <button type="button" name="view" value="view" id="<?php echo $gg->gl_no ?>"
                                            class=" btn yellow-saffron yellow-gold-stripe pull-right btn-xs view_data">
