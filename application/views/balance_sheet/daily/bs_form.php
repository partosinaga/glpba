        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-balance-scale"></i>Daily Balance Sheet Form</h3>
                </div>
                <div class="box-body">
                    <div class="page-content-inner">
                        <form method="get" action="<?php echo site_url("balance_sheet/bsd/view_bsd") ?>" target="_blank">
                            <div class="row">
                                <div class="col-md-3">
