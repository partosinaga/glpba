        ...
        <table class="table table-report table-striped table-hover" style="margin-top:0px;margin-bottom:15px;background:#ffffff;">
            ...
            <?php foreach($rowData as $r): ?>
                <tr>
                    ...
                    <td align="right" class="content"><?php echo number_format($r->balance+$balance) ?></td>
                </tr>
            <?php endforeach ?>
            <tr>
                <th colspan="2" class="text-right">TOTAL</th>
                <th align="right" class="text-right" style="background-color: #e4e4e4"><?php echo number_format($r->balance+$balance) ?></th>
            </tr>
            </tbody>
        </table>
