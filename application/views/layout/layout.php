...
<section class="content">
    <div class="box box-success">
        ...
        <div class="box-header with-border">
            ...
            <br>
            <h3 class="box-title"><i class="fa fa-dot-circle-o"></i> Balance sheet</h3>
            ...
            <div class="pull-right box-tools">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="javascript:;"><i class="fa fa-dot-circle-o"></i> Balance sheet</a>
                    </li>
                    <li>
    ...
    <div class="modal-body">
        <form id="new-category">
            <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" id="id_category" name="id_category">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" id="id_subcategory" name="id_subcategory">
                    <option value="" selected="selected" disabled>select</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="hidden" name="report_id" value="1" class="form-control">
