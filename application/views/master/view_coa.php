                            ...
                            <div class="portlet light ">
                                <div class="portlet-body">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li>
                                            <a href="#tab_1_2" data-toggle="tab"><i class="fa fa-folder-open"></i>
                                                Subgroup </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="dropdown" data-toggle="dropdown"><i
                                                    class="fa fa-file-excel-o"></i> Export </a>
                                            <ul class="dropdown-menu">
                                                <li><a href="<?php echo site_url('master/coa/export_coa') ?>"><i
                                                            class="fa fa-list"></i> COA</a></li>
                                            </ul>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade active in" id="tab_1_1"><br>
                                            ...
                                            <div class="portlet light bordered">
                                                <form role="form" method="POST"
                                                      action="<?php echo site_url() . '/master/coa/add_group' ?>">
                                                    <div class="form-body">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                        ...
                                                        <table id="example" class="table table-striped table-bordered"
                                                            ...
                                                            foreach ($group as $g) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        <a data-target="#static<?php echo $g->group_id; ?>"
                                                                           data-toggle="modal">
                                                                            <button type="button"
                                                                                    class="btn default red-stripe btn-xs">
                                                                                <i class="fa fa-trash"></i> delete
                                                                            </button>
                                                                        </a>
                                                                        <a href="<?php echo site_url() . '/master/coa/edit_group/' . $g->group_id; ?>">
                                                                            <button type="button"
                                                                                    class="btn default blue-stripe btn-xs">
                                                                ...
                                                                <!--MODAL CONFIRMATION-->
                                                                <div id="static<?php echo $g->group_id; ?>"
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" data-dismiss="modal"
                                                                                form="form1" class="btn btn-danger"><i
                                        ...
                                        <div class="tab-pane fade" id="tab_1_2">
                                            <div class="portlet light bordered">
                                                <form role="form" method="POST"
                                                      action="<?php echo site_url() . '/master/coa/add_subgroup' ?>">
                                                    <div class="form-body">
                                                        <div class="row">
                                                        ...
                                                        <table id="example1" class="table table-striped table-bordered"
                                                            ...
                                                            foreach ($subgroup as $sg) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        <a data-target="#static<?php echo $sg->subgroup_id; ?>"
                                                                           data-toggle="modal">
                                                                            <button type="button"
                                                                                    class="btn default red-stripe btn-xs">
                                                                                <i class="fa fa-trash"></i> delete
                                                                        ...
                                                                        <a href="<?php echo site_url() . '/master/coa/edit_subgroup/' . $sg->subgroup_id; ?>">
                                                                            <button type="button"
                                                                                    class="btn default blue-stripe btn-xs">
                                                                                <i class="fa fa-edit"></i> edit
                                                                            </button>
                                                                ...
                                                                <!--MODAL CONFIRMATION-->
                                                                <div id="static<?php echo $sg->subgroup_id; ?>"
                                                                     class="modal fade" tabindex="-1"
                                                                     data-backdrop="static" data-keyboard="false">
                                                                    <div class="modal-header">
                                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="tab_1_3">
                                            <div class="portlet light bordered">
                                                <form role="form" method="POST"
                                                      action="<?php echo site_url() . '/master/coa/add_coa' ?>">
                                                    <div class="form-body">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-icon">
                                                                        <select class="form-control select2"
                                                                                name="subgroup">
                                                                            <option value="" selected>Select Subgroup
                                                                                Account
                                                                            </option>
                                                                            <?php
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-icon">
                                                                        ...
                                                                        <input type="text" name="debit"
                                                                               ...
                                                                               value="0" placeholder="Description"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label>Cashflow Position<i style="font-size: 7pt">*optional</i></label>
                                                                    <div class="input-icon">
                                                                        <select class="form-control select2" name="cashflow">
                                                                            <option value="" disabled selected>&nbsp</option>
                                            ...
                                            <div class="box-body">
                                                <div class="page-content-inner">
                                                    <div class="m-heading-1 border-green scrollme ">

                                                        <table id="example2" class="table table-bordered table-hover"cellspacing="0">
                                                            <thead>
                                                            <tr>
                                                                <th width="50px">CODE</th>
                                                                <th>DESCRIPTION</th>
                                                                <th width="50">DATE</th>
                                                                <th width="50">CASHFLOW</th>
                                                            ...
                                                            <?php
                                                                ...
                                                                foreach ($coa as $c) {
                                                                if($c->cashflow == 'opr'){
                                                                    $cashflow = ' <span class="label label-primary">OPERASIONAL</span>';
                                                                }else if($c->cashflow == 'inv'){
                                                                    $cashflow = ' <span class="label label-info">INVESTASI</span>';
                                                                }else if($c->cashflow == 'keu'){
                                                                    $cashflow = ' <span class="label label-warning">KEUANGAN</span>';
                                                                } else{
                                                                    $cashflow = '';
                                                                }
                                                                ?>
                                                                <tr>
                                                                    ...
                                                                    <td align="center"> <?php echo $cashflow ?> </td>
                                                                    <td> <?php echo $c->subgroup; ?> </td>
                                                                    <td align="right"> <?php echo number_format($c->debit); ?></td>
                                                                    <td align="right"> <?php echo number_format($c->credit); ?></td>
                                                                    <td align="center">
                                                                        <?php
                                                                        if ($c->header == "header") {
                                                                            echo "&#10004";
                                                                    ...
                                                                    <td align="center">
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                                <li>
                                                                                    <a href="<?php echo site_url('master/coa/edit_coa/' . $c->id) ?>"><i class="fa fa-edit"></i> Edit </a>
                                                                                </li>
                                                                                <li>
                                                                    ...
                                                                    <!--MODAL CONFIRMATION-->
                                                                    <div id="static<?php echo $c->coa_id; ?>"
                                                                         class="modal fade" tabindex="-1"
                                                                         data-backdrop="static" data-keyboard="false">
                                                                        <div class="modal-header">
                                                                        </div>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="button" data-dismiss="modal"
                                                                                    form="form1" class="btn btn-danger">
